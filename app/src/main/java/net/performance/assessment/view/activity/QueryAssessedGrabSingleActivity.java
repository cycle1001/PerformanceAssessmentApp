 ...
 * 抢单进行中列表
 */
public class QueryAssessedGrabSingleActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    protected void initView() {
        super.initView();
        mCustomTitleBar.setTitle("完成待考核");
    ...
    protected void initData() {
        ...
        mLoadingDialog.show();
        mQueryFlag = OrderSheetTaskAPI.orderSheetQuery("", "", "004", mHttpCallback);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (mSelectGrabBean != null) {
            Intent intent = new Intent(this, GrabSinglePerformanceAppraisalActivity.class);
