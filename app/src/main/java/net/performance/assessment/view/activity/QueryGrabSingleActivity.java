 ...
 * 抢单待审核列表
 */
public class QueryGrabSingleActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    protected void initData() {
        ...
        mLoadingDialog.show();
        mQueryFlag = OrderSheetTaskAPI.orderSheetQuery("", "", "001", mHttpCallback);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (mSelectGrabBean != null) {
            Intent intent = new Intent(this, GrabSingleApprovalActivity.class);
