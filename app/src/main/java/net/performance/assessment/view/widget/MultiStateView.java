...
import net.performance.assessment.interfaces.AnimatorProvider;
 ...
 *  自定义多状态控件
 *
 *  模仿ViewStub实现懒加载，控制页面显示加载、重试和无数据时的信息
 */

public class MultiStateView extends View
{

    @IntDef( { EMPTY, RETRY, LOADING , CONTENT})
    ...
    public static final int CONTENT = 0x00000003;
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull Activity activity ) {
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull Activity activity, boolean hasActionBar) {
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull ViewGroup parent) {
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull ViewGroup parent, boolean hasActionBar) {
        ...
        MultiStateView stateView = new MultiStateView(parent.getContext());
        if (screenHeight > 0) {
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull View view) {
     ...
     * @return StateView
     */
    public static MultiStateView inject(@NonNull View view, boolean hasActionBar) {
    ...
    public MultiStateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultiStateView );
        mEmptyResource = a.getResourceId(R.styleable.MultiStateView_empty_layout, 0);
        mRetryResource = a.getResourceId(R.styleable.MultiStateView_retry_layout, 0);
        mLoadingResource = a.getResourceId(R.styleable.MultiStateView_loading_layout, 0);
        a.recycle();
    ...
    public void showContent() {
        if ( mContentView != null )
        {
            ...
            mContentView = inflateContentView( mContentResource );
            //inflate( mContentResource , EMPTY);
        }
        setVisibility(GONE);
    }
    ...
    private View inflateContentView( @LayoutRes int layoutResource ){
        final ViewParent viewParent = getParent();
    ...
    public void setContentResource( int contentResource )
    {
        mContentResource = contentResource;
    }
     ...
     * inflated its layout resource.
     *
     * @see MultiStateView#setOnInflateListener(OnInflateListener)
     */
