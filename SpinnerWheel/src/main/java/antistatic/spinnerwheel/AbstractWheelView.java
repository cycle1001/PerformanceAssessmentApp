...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected static final int DEF_ITEMS_DIMMED_ALPHA = 90; // 60 in ICS

    protected static final int DEF_SELECTION_DIVIDER_ACTIVE_ALPHA = 100;

    protected static final int DEF_SELECTION_DIVIDER_DIMMED_ALPHA = 100;
    ...
    protected void initData(Context context) {
        ...
        mSelectorWheelPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
    }
